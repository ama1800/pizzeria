...
var $addCollectionButton = $('<button type="button" class="add_collection_link">Ajouter Image</button>');
var $delCollectionButton = $('<button type="button" class="del_collection_link">Supprimer Image</button>');
